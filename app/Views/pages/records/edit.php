...
<div class="container-fluid">
    <div class="row">
        <div class="col-12 mb-3">
            <h2 class="m-0">Edit Record</h2>
        </div>
        <div class="col-md-8 offset-md-2">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Update Record Information</h3>
                </div>
                <div class="card-body">
                    <form action="/records/update/<?= $record['id'] ?>" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="category" class="form-control" required>
                                ...
                                <option value="Technology" <?= old('category', $record['category']) == 'Technology' ? 'selected' : '' ?>>Technology</option>
                                <option value="Business" <?= old('category', $record['category']) == 'Business' ? 'selected' : '' ?>>Business</option>
                                <option value="Education" <?= old('category', $record['category']) == 'Education' ? 'selected' : '' ?>>Education</option>
                                <option value="Health" <?= old('category', $record['category']) == 'Health' ? 'selected' : '' ?>>Health</option>
                                <option value="Other" <?= old('category', $record['category']) == 'Other' ? 'selected' : '' ?>>Other</option>
                            </select>
